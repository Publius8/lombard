...
//........................................................................................................
if ((isset($_POST['name_surname']) && $_POST['name_surname'] != "") && (isset($_POST['client_email']) &&
    $_POST['client_email'] != "") && (isset($_POST['notes']) && $_POST['notes'] != "")) {



    $mail = new MailAgent();

    $mail->_SMTPServer = 'data2.web.az';
    $mail->_SMTPLogin = 'info@dostlombard.az';
    $mail->_SMTPPass = 'YHmJm#tL99=G';
    $mail->_SMTPPort = 465;
    $mail->_SMTPAuth = 1;
    //        $mail->_SMTPSecure = 'tls';
    //        $mail->_SMTPSecure = 'ssl';
    $mail->_mailFrom = 'info@dostlombard.az';
    ...
    $message =
        "<div>
                        ...
                        <td style='display: flex;flex-direction: column;flex-direction: left;margin-top: 10px;border-collapse: collapse;padding: 10px 20px;'>" . $_POST['client_email'] . "</td>
                        <th style='display: flex;flex-direction: left; margin-top: 10px; color: #187232; background-color: #F57731; border-collapse: collapse; padding: 10px 20px;'>Rəyiniz</th>
                        <td style='display: flex;flex-direction: column;flex-direction: left;margin-top: 10px;border-collapse: collapse;padding: 10px 20px;'>" . $_POST['notes'] . "</td>
                      </tr>
                      <tr>
                    </tr>
                        </table>
